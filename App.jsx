      ...
      <div className="max-w-6xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6 relative">
          ...
          <div className="absolute top-6 right-6 text-right text-sm leading-tight">
            <div>{programData.subtitle}</div>
            <div>{programData.programInfo}</div>
        ...
        <div className="bg-pink-600 text-white p-4">
          <h2 className="text-lg md:text-xl font-bold">{programData.mainTitle}</h2>
        </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <div className="mb-8">
                ...
                <ul className="space-y-3 mb-6">
                  {programData.questions.map((question, index) => (
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {programData.companies.map((company, index) => (
                    <li key={index} className="flex items-start text-sm">
                      <span className="text-blue-500 font-bold mr-3 mt-1">•</span>
                      <span>{company}</span>
                    </li>
